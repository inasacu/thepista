...
#       if name == "Centro Deportivo Municipal Luis Aragones"
...
#   puts
# 
#   search_and_replace = ['Descripc', 'Forma de gest', 'Forma de Gest', 'Directa, por parte del Ayuntamiento de Madrid']
# 
#   search_and_add_br = ['Tipo de Gest Superficie', 'EQUIPAMIENTOS', 'Unidades Deportivas al aire libre', 'Unidades Deportivas Cubiertas', 'SERVICIOS',
#     'Deportes Practicables', 'Alquiler y/o uso libre de Unidades Deportivas', 'Enseñanzas Deportivas', 'Oficina de promoc deportiva']
# 
