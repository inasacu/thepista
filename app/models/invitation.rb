class Invitation < ActiveRecord::Base
  ...
  after_save :send_invite, :send_invite_contact
  ...
  def send_invite
    ...
    # emails.each{|email|
    #   # UserMailer.deliver_signup_invitation(email, self.user, self.message)
    #   UserMailer.send_later(:signup_invitation, self)
    # }
  end
