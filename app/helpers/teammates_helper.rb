module TeammatesHelper
  ...
  def join_item_link_to(user, item, extend_label=false, unique_label=false)
    ...
    link_to("#{the_label}".html_safe, join_item_path(:id => item, :item => item.class.to_s, :teammate => user))
  end

  def join_item_sub_item_link_to(user, item, sub_item, extend_label=false)
    the_label = label_name(:add_to_item)
    link_to("#{the_label}".html_safe, join_item_path(:id => item, :item => item.class.to_s, :sub_id => sub_item, :sub_item => sub_item.class.to_s, :teammate => user)) 
  end	
  ...
  def leave_item_link_to(user, item)
    ...
    # link_to("#{the_label}".html_safe, fire_path(:id => item, :leave => user), :confirm => the_confirmation) 
    ...
    link_to("#{the_label}".html_safe, leave_item_path(:id => item, :item => item.class.to_s, :teammate => user), :confirm => the_confirmation) 
  end
  ...
  def leave_item_sub_item_link_to(user, item, sub_item)
    ...
    link_to("#{the_label}".html_safe, leave_item_path(:id => item, :item => item.class.to_s, :sub_id => sub_item, :sub_item => sub_item.class.to_s, :teammate => user), :confirm => the_confirmation)
  end
  ...
  def manage_item_link_to(user, item, extend_label=false)
    ...
    link_to("#{the_label}".html_safe, manage_join_path(:id => item, :teammate => user), :confirm => the_confirmation)
  end
end
