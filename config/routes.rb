# == Route Map (Updated 2014-05-24 18:09)
#
# No such file to load -- Browser
# No such file to load -- Canvas
# No such file to load -- Firefox
#                                      root        /                                                              home#index
#                                                  /                                                              home#index
...
#                     mobile_security_index GET    /mobile/security(.:format)                                     mobile/security#index
#                                           POST   /mobile/security(.:format)                                     mobile/security#create
#                       new_mobile_security GET    /mobile/security/new(.:format)                                 mobile/security#new
#                      edit_mobile_security GET    /mobile/security/:id/edit(.:format)                            mobile/security#edit
#                           mobile_security GET    /mobile/security/:id(.:format)                                 mobile/security#show
#                                           PUT    /mobile/security/:id(.:format)                                 mobile/security#update
#                                           DELETE /mobile/security/:id(.:format)                                 mobile/security#destroy
#                register_mobile_user_index POST   /mobile/user/register(.:format)                                mobile/user#user_registration
#                                           POST   /mobile/user/logout/:user_id(.:format)                         mobile/user#user_logout
#                                           GET    /mobile/user/account_info/:user_id(.:format)                   mobile/user#user_account_info
#                         mobile_user_index GET    /mobile/user(.:format)                                         mobile/user#index
#                                           POST   /mobile/user(.:format)                                         mobile/user#create
#                           new_mobile_user GET    /mobile/user/new(.:format)                                     mobile/user#new
#                          edit_mobile_user GET    /mobile/user/:id/edit(.:format)                                mobile/user#edit
#                               mobile_user GET    /mobile/user/:id(.:format)                                     mobile/user#show
#                                           PUT    /mobile/user/:id(.:format)                                     mobile/user#update
#                                           DELETE /mobile/user/:id(.:format)                                     mobile/user#destroy
#                                           GET    /mobile/event/active_by_user/:user_id(.:format)                mobile/event#active_events_by_user
#                                           GET    /mobile/event/active_by_user_groups/:user_id(.:format)         mobile/event#active_events_by_user_groups
#                                           GET    /mobile/event/user_history/:user_id/:offset_factor(.:format)   mobile/event#historical_of_events
#                                           GET    /mobile/event/by_id/:event_id(.:format)                        mobile/event#event_by_id
#                                           GET    /mobile/event/user_data/:event_id/:user_id(.:format)           mobile/event#get_user_event_data
#                                           GET    /mobile/event/get_info/:event_id/:user_id(.:format)            mobile/event#get_event_info_related_to_user
#                                           GET    /mobile/event/get_teams/:event_id(.:format)                    mobile/event#get_event_teams
#                                           GET    /mobile/event/get_results/:event_id(.:format)                  mobile/event#get_event_results
#                                           GET    /mobile/event/forum/get_comments/:event_id(.:format)           mobile/event#get_forum_comments
#      change_user_state_mobile_event_index POST   /mobile/event/change_user_state(.:format)                      mobile/event#change_user_event_state
#             create_new_mobile_event_index POST   /mobile/event/create_new(.:format)                             mobile/event#create_event
#                   edit_mobile_event_index POST   /mobile/event/edit(.:format)                                   mobile/event#edit_event
#   update_event_results_mobile_event_index POST   /mobile/event/update_event_results(.:format)                   mobile/event#update_event_results
# change_user_event_team_mobile_event_index POST   /mobile/event/change_user_event_team(.:format)                 mobile/event#change_user_event_team
#      forum_add_comment_mobile_event_index POST   /mobile/event/forum/add_comment(.:format)                      mobile/event#add_forum_comment
#                        mobile_event_index GET    /mobile/event(.:format)                                        mobile/event#index
#                                           POST   /mobile/event(.:format)                                        mobile/event#create
#                          new_mobile_event GET    /mobile/event/new(.:format)                                    mobile/event#new
#                         edit_mobile_event GET    /mobile/event/:id/edit(.:format)                               mobile/event#edit
#                              mobile_event GET    /mobile/event/:id(.:format)                                    mobile/event#show
#                                           PUT    /mobile/event/:id(.:format)                                    mobile/event#update
#                                           DELETE /mobile/event/:id(.:format)                                    mobile/event#destroy
#                                           GET    /mobile/group/by_user/:user_id(.:format)                       mobile/group#groups_by_user
#                                           GET    /mobile/group/get_info/:group_id/:user_id(.:format)            mobile/group#get_info_related_to_user
#                starred_mobile_group_index GET    /mobile/group/starred(.:format)                                mobile/group#starred_groups
#                                           GET    /mobile/group/events/:group_id(.:format)                       mobile/group#group_events
#                                           GET    /mobile/group/members/:group_id(.:format)                      mobile/group#group_members
#             create_new_mobile_group_index POST   /mobile/group/create_new(.:format)                             mobile/group#create_group
#             add_member_mobile_group_index POST   /mobile/group/add_member(.:format)                             mobile/group#add_member
#                        mobile_group_index GET    /mobile/group(.:format)                                        mobile/group#index
#                                           POST   /mobile/group(.:format)                                        mobile/group#create
#                          new_mobile_group GET    /mobile/group/new(.:format)                                    mobile/group#new
#                         edit_mobile_group GET    /mobile/group/:id/edit(.:format)                               mobile/group#edit
#                              mobile_group GET    /mobile/group/:id(.:format)                                    mobile/group#show
#                                           PUT    /mobile/group/:id(.:format)                                    mobile/group#update
#                                           DELETE /mobile/group/:id(.:format)                                    mobile/group#destroy
#                starred_mobile_venue_index GET    /mobile/venue/starred(.:format)                                mobile/venue#starred_venues
#                                           GET    /mobile/venue/events/:venue_id(.:format)                       mobile/venue#venue_events
#                                           GET    /mobile/venue/get_info/:venue_id(.:format)                     mobile/venue#get_info
#                        mobile_venue_index GET    /mobile/venue(.:format)                                        mobile/venue#index
#                                           POST   /mobile/venue(.:format)                                        mobile/venue#create
#                          new_mobile_venue GET    /mobile/venue/new(.:format)                                    mobile/venue#new
#                         edit_mobile_venue GET    /mobile/venue/:id/edit(.:format)                               mobile/venue#edit
#                              mobile_venue GET    /mobile/venue/:id(.:format)                                    mobile/venue#show
#                                           PUT    /mobile/venue/:id(.:format)                                    mobile/venue#update
#                                           DELETE /mobile/venue/:id(.:format)                                    mobile/venue#destroy
#                  cities_mobile_util_index GET    /mobile/util/cities(.:format)                                  mobile/util#get_cities
#                  sports_mobile_util_index GET    /mobile/util/sports(.:format)                                  mobile/util#get_sports
#                         mobile_util_index GET    /mobile/util(.:format)                                         mobile/util#index
#                                           POST   /mobile/util(.:format)                                         mobile/util#create
#                           new_mobile_util GET    /mobile/util/new(.:format)                                     mobile/util#new
#                          edit_mobile_util GET    /mobile/util/:id/edit(.:format)                                mobile/util#edit
#                               mobile_util GET    /mobile/util/:id(.:format)                                     mobile/util#show
#                                           PUT    /mobile/util/:id(.:format)                                     mobile/util#update
#                                           DELETE /mobile/util/:id(.:format)                                     mobile/util#destroy
...
#                          activate_session        /activa_session(.:format)                                      users#activate_session
...
Thepista::Application.routes.draw do
  ...
  match 'confirmacion/:token' => 'users#confirmation', :as => :confirmation_token
	...
	match 'yo' => 'matches#set_yo_convocado', :as => :yo
