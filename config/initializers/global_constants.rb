...
DISPLAY_GROUP_GMAP = true
DISPLAY_DEFAULTS = false
DISPLAY_GOOGLE_PLUS = false
...
DISPLAY_INVITATION_AT_LOGIN = false
DISPLAY_PLAYER_POSITION = false
DISPLAY_FUTBOL_ASSIST = false
DISPLAY_SEARCH_OPTION = false
DISPLAY_GROUP_BLOG = false

DISPLAY_HAYPISTA_TEMPLATE = true
DISPLAY_HAYPISTA_SIGNUP = false

DISPLAY_SEND_REMINDERS = false
