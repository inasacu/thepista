    ...
    if (request.readyState == 4) {
      ...
      for (var i = 0 ; i < markers.length ; i++) {
        ...
        var html = "<table summary=\"Details\" width=\"350\" style=\"font-size: 10px\"><tr><td><strong>"
             ...
             + marker.id + "&name=" + marker.name + "','comment',260,500,1,event,0);return false\" target=\"_blank\">Add update</a></td></tr></table></td></tr><tr><td><img src=\"../images/invis.gif\" height=\"0\" width=\"350\"></td></tr>" 
